...
2008 or its redistributables are required for them to be used. The same 
applies to their redistributions.

The VS2008 sln file used to build the components is in the 
./src/build/vc2008/ directory. This redistribution of PCRE is built
with SUPPORT_JIT and SUPPORT_UTF8 both enabled. If you desire 
different options, amend the config.h file in the abovementioned 
