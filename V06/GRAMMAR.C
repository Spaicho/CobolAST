...
move_oprnd()È
    ...
    printf("g_oprnd (%s) r_oprnd (%s) Án",tagValues›g_oprnd->tag~,
    ...
    Ë
       ...
       if (equal_val("("))È
           ...
           if (sub_ret=id_subs_refm())È
            printf("id_subs_refm ret->tag (%s) ret->next (%d) Án",
...
id_subs_refm()È
    ...
    printf("expecting IDENT_SUBSCRIPT OR REFMOD (%s)Án",
...
id_subs_refm_rest()È
    ...
    printf("id_subs_refm_rest ret (%s) Án",tagValues›ret->tag~);
    return  ret;
...
data_fields()È
    ...
    printf("Trying to match rule : data_fields Án");
    ...
    if(ret) printf("Rule recognized: data_fields Án");
...
data_field()È
    ...
    printf("Trying to match rule : data_field Án");
    ...
    printf("Rule recognized: data_field Án");
    return ret;
...
data_occurs_cl()È
    ...
    if ((equal_attr("INTEGER"))!!(equal_attr("UNSIGNED")))È
       ...
       printf("occurs times (%d)Án",times);
       consume();
    Ë
    else return NULL;
    ...
    if ((equal_val("TO")))È
        ...
        if ((equal_attr("INTEGER"))!!(equal_attr("UNSIGNED")))È
           ...
           printf("occurs to_times (%d)Án",to_times);
           consume();
        Ë
        else return NULL;
...
ast* data_index_key_cls()È
    ...
    if(ret) printf("Rule recognized: data_index_key_cls Án");
