  ...
  */
  ...
  /*---------------------------------------------------------------*/
    ...
    while ((i < nb_regex_for_type) &&
        ...
        printf("pregs.name            (%s)Án",pregs›i~.name);
        printf("args+pmatch2.rm_eo-1  (%d)Án",args+pmatch›2~.rm_eo-1);
        printf("*args+pmatch2.rm_eo-1 (%c)Án",
                                          *(args+pmatch›2~.rm_eo-1));
        printf("strlen(args)          (%d)Án",strlen(args));
        printf("pmatch2.rm_eo         (%d)Án",(pmatch›2~.rm_eo));
        printf("*(args+(pmatch2.rm_eo)(%c)Án",
                                          *(args+(pmatch›2~.rm_eo)));
        Ë */
