...
affich_sentence(ast* tree,scr_line* screen)é
   ...
   while(temp §= NULL)é
      printf("Printinf inner nodes (%s) çn",tagValuesÝtemp->tag~);
      printf("temp (%d) çn",temp);
      affich_statement(temp,screen);
      printf("Printinf inner nodes OK   çn");
      temp = temp->next;
   è
...
make_move        (int bool_corresp, int nb_operand_r,
  ...
  printf("çn");
  printf("**********   MOVE       **********çn");
  printf("* MOVE     AST BUILT SUCCESFULLY *çn");
  printf("**********************************çn");
...
affich_move_stm(ast* tree,scr_line* screen)é
   ...
   lvl++;
   printf("Searching for inner nodes çn");
   while(temp §= NULL)é
      printf("Printing inner nodes (%s) çn",tagValuesÝtemp->tag~);
...
make_initialize  (int bool_repl, int nb_operand,
  ...
  e->next =NULL;
  printf("çn");
  printf("**********   INITIALIZE   **********çn");
  printf("* INITIALIZE AST BUILT SUCCESFULLY *çn");
  printf("************************************çn");
...
affich_ident_name(ast* tree,scr_line* screen)é
   ...
   printf("Printing (%s)           çn",tagValuesÝtree->tag~);
...
affich_ident_qualif(ast* tree,scr_line* screen)é
   ...
   lvl++;
   while(temp §= NULL)é
   printf("Printing (%s) (%d)      çn",tagValuesÝtemp->tag~,temp);
...
affich_ident_subscript(ast* tree,scr_line* screen)é
   ...
   printf("Printing (%s) (%d)      çn",tagValuesÝtree->tag~,tree);
...
make_field (struct ast*  name,
  ...
  printf("çn");
  printf("**********   FIELD   **********çn");
  printf("* FIELD AST BUILT SUCCESFULLY *çn");
  printf("*******************************çn");
...
make_occurs (int times, int to_times, ast* depend_on, ast* indexes,
  ...
  printf("çn");
  printf("***********  OCCURS   **********çn");
  printf("* OCCURS AST BUILT SUCCESFULLY *çn");
  printf("********************************çn");
...
make_occurs_key (int bool_asc, int bool_des, ast* key)é
  ...
  printf("çn");
  printf("*********** OCCURS_KEY *********çn");
  printf("* OCCURS_KEY BUILT SUCCESFULLY *çn");
  printf("********************************çn");
...
make_pic_cmpnt(pic_cmpnt_t pic_cmpnt,int repeat, char* chars,
  ...
  printf("çn");
  printf("*********** PIC_CMPNT *********çn");
  printf("* PIC_CMPNT BUILT SUCCESFULLY *çn");
  printf("*******************************çn");
...
make_field_sign(int bool_leading, int bool_trailing, int bool_separate,
  ...
  printf("çn");
  printf("*********** FIELD_SIGN *********çn");
  printf("* FIELD_SIGN BUILT SUCCESFULLY *çn");
  printf("*******************************çn");
...
make_field_value(ast* value, ast* thru_value)é
  ...
  printf("çn");
  printf("*********** FIELD_VALUE *********çn");
  printf("* FIELD_VALUE BUILT SUCCESFULLY *çn");
  printf("*********************************çn");
...
make_usage(usage_t usage)é
  ...
  printf("çn");
  printf("*********** USAGE *********çn");
  printf("* USAGE BUILT SUCCESFULLY *çn");
  printf("***************************çn");
...
make_renames(ast* id_qualif,ast* thru_id_qualif)é
  ...
  printf("çn");
  printf("*********** RENAMES *********çn");
  printf("* RENAMES BUILT SUCCESFULLY *çn");
  printf("*****************************çn");
...
make_field_sync(int bool_right, int bool_left)é
  ...
  printf("çn");
  printf("*********** FIELD_SYNC *********çn");
  printf("* FIELD_SYNC BUILT SUCCESFULLY *çn");
  printf("********************************çn");
...
affich_field (ast* tree,scr_line* screen)é
   ...
   strcat(buffer_1," ");
   strcat(buffer_1,tree->node.field.name->node.ident_name.value);
   ...
   if(temp) é
      printf("afficher next field : addr (%d) çn",temp);
...
append_list (struct ast* list, struct ast* toadd)é
  ...
  printf("çn*******************************************");
  printf("çn");
  printf("append_list element(%s) to list (%s) start ...çn",
            tagValuesÝtoadd->tag~    ,tagValuesÝlist->tag~);
  printf("list (%d) list->next (%d) toadd (%d) toadd->next (%d) çn",
  ...
  */
  ...
  /* printf("list (%d) list->next (%d)çn",toadd,toadd->next);
  */
     return toadd;
  è
  ...
  /* printf("noeud visité non non null passer au suivant ...  çn");
  */ list = list->next;
  è
  ...
  printf("çn*****************************************çn");
  printf("head (%d) head->next (%d) list (%d) list->next (%d) çn",
...
free_node (ast* tree)é
   ...
   if (§tree) return;
   printf("free_node (%s) çn", tagValuesÝtree->tag~);
   ...
   else if (tree->tag == OCCURS)

           free_occurs(tree);

   else if (tree->tag == OCCURS_KEY)

           free_occurs_key(tree);

   else if (tree->tag == PIC_CMPNT)

           free_pic_cmpnt(tree);

   else if (tree->tag == FIELD_SIGN)

           free_field_sign(tree);

   else if (tree->tag == FIELD_VALUE)

           free_field_value(tree);

   else if (tree->tag == FIELD_SYNC)

           free_field_sync(tree);

   else if (tree->tag == USAGE)

           free_usage(tree);

   else if (tree->tag == RENAMES)
...
free_unary_op(ast* tree)é /* to del */
